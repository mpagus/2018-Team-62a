...
void normalStackCone(int cone){
	if(cone == 1){
		...
		wait1Msec(1100);
		desiredStage2 = 600 + stage2Limit;
	}
	else if(cone == 7){
		desiredStage1 = -1240;
		wait1Msec(650);
		desiredStage2 = 900 + stage2Limit;
		wait1Msec(1000);
		...
		wait1Msec(700);
		desiredStage2 = 1105 + stage2Limit;
		wait1Msec(1200);
		desiredStage2 = 800 + stage2Limit;
	}
	else if(cone == 9){
		...
		desiredStage2 = 2100 + stage2Limit;
		wait1Msec(700);
		desiredStage1 = -1095;
		wait1Msec(1300);
		desiredStage2 = 1700 + stage2Limit;
	}
}
...
void groundPickUpCone(int stack){
	if(stack == 7){
		...
		desiredStage2 = 2950 + stage2Limit;
		wait1Msec(400);
		desiredStage1 = -495;
		wait1Msec(600);
	}
...
task coneControl(){
	...
	while(true){
		...
		if(highGoal){
			...
			if(vexRT[Btn8U] != incButton){
				incButton = !incButton;
				if(incButton && currentHighConeStack < 6){
					currentHighConeStack++;
					if(intakeUp)
						highStackCone(currentHighConeStack);
				}
